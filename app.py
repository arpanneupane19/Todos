...
app.config['MAIL_USERNAME'] = 'todosapp1490@gmail.com'
app.config['MAIL_PASSWORD'] = 'lu4pa3668'
...
class CreateForm(FlaskForm):
	...
	due_date = DateTimeLocalField('Which date is your favorite?', format='%m/%d/%y', validators=[InputRequired()])
